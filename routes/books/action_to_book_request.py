...
from db import db
from controllers.books import action_to_book_request as ActionToBookRequest
...
@jwt_required()
def action_to_book_request_route():
    ...
    bookId =  ActionToBookRequest.action_to_book_request_controller(
        db,
